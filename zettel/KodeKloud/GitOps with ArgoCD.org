...
Il va monitorer une source de vérité, par exemple des dépôts Git, puis comparer l'état déclarer (depot Git) à l'état actuel ([[file:Certified Kubernetes Administrator/Kubernetes.org][Kubernetes]]).
