...
L'URI identifie une ressource réseau, sa syntaxe est basée sur les spécificités Internet Protocol (certaines rfc). Peut être de type «locator» ou «name» ou les deux.
